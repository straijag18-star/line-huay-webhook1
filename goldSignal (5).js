...
// ---------------------------------------------------------------
// 1.1) ดึงแค่แท่งล่าสุด (ใช้เช็คว่าราคาปัจจุบันชน SL/TP ของเทรดที่เปิดอยู่หรือยัง)
// ---------------------------------------------------------------
async function getLatestCandle() {
  const candles = await fetchCandles('1m', 2);
...
module.exports = { analyzeGoldSignal, formatSignalMessage, generateChartImageUrl, getLatestCandle };
